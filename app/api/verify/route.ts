...
export async function GET(req: Request) {
  ...
  const html = `
    ...
    <body>
      <div class="container">
        <div class="logo">
          <img src="https://${process.env.NEXT_PUBLIC_SITE_URL}/assets/NambikeJustLogo.png" alt="Nambike Logo" />
          <h1>Nambike</h1>
        </div>
        <div class="success-icon">✅</div>
        <h2>Email Successfully Verified!</h2>
        <p>Thank you for verifying your email address. We'll be in touch soon with updates about your submission.</p>
        <a href="https://${process.env.NEXT_PUBLIC_SITE_URL}" class="button">Return to Nambike</a>
      </div>
    </body>
    </html>
  `;
